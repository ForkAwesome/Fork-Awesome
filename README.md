...
ℹ️ **Update 2021-07-09** ℹ️ Several users of Forkawesome realized that the project was becoming more and more inactive, with no end-user update for [over 2 years](https://github.com/ForkAwesome/Fork-Awesome/commits/gh-pages) 😴 We want to reawaken this project! 🚀 We're gradually inheriting the project from the previous maintainers, and there's a lot of work to do 👷 Catching up with backlogged issues and PR's, updating technology and documentation — even reevaluating the project aims, as icon fonts gradually [become](https://www.irigoyen.dev/blog/2021/02/17/stop-using-icon-fonts/) [deprecated](https://cloudfour.com/thinks/seriously-dont-use-icon-fonts/). Come say hi in the [#forkawesome:matrix.org](https://app.element.io/#/room/#forkawesome:matrix.org) matrix room 🙂
